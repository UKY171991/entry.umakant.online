...
try {
    ...
    Write-Host "✗ Error testing Website Development Update template: $($_.Exception.Message)" -ForegroundColor Red
}

Write-Host "`nAll email template tests completed!" -ForegroundColor Green
