...
class PathologyManagement extends Mailable
{
    ...
    public function __construct($data)
    {
        ...
        if (is_array($data)) {
            ...
            $this->data = [
                ...
                'projectName' => $args[1] ?? 'Pathology Management System',
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Pathology Management System Proposal - ' . $clientName,
        );
    }
    ...
    {
        return new Content(
            view: 'emails.templates.pathology_management',
            with: $this->data,
        );
    }
