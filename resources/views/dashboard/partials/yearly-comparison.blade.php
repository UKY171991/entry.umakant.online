{{-- Yearly Income vs Target Comparison Widget --}}
<div class="card income-comparison-card yearly-card h-100 shadow-sm">
    <div class="card-header">
        <h3 class="card-title text-white">
            <i class="fas fa-calendar mr-2"></i>
            <span class="d-none d-sm-inline">Yearly Income vs Target</span>
            <span class="d-inline d-sm-none">Yearly Target</span>
        </h3>
        <div class="card-tools">
            <span class="badge badge-light">{{ now()->format('Y') }}</span>
        </div>
    </div>
    <div class="card-body">
        @if($data['has_target'])
                    ...
                    <div class="description-block border-right border-sm-right border-bottom border-sm-bottom-0 pb-3 pb-sm-0 mb-3 mb-sm-0">
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="text-center">
                                <i class="fas fa-chart-line text-success mb-2 d-block" style="font-size: 1.2rem;"></i>
            ...
            <div class="mt-3 text-center">
                ...
                @elseif($percentage >= 100)
                    <span class="badge badge-pill badge-success px-3 py-2 shadow-sm" style="font-size: 0.9rem;">
                        <i class="fas fa-trophy mr-1"></i> Annual Target Achieved!
                    </span>
                @elseif($percentage >= 80)
                    <span class="badge badge-pill badge-warning px-3 py-2 shadow-sm" style="font-size: 0.9rem;">
                        <i class="fas fa-clock mr-1"></i> Close to Annual Target
                    </span>
                @elseif($percentage >= 50)
        ...
        @else
            ...
            <div class="text-center py-5">
                ...
                <p class="text-muted px-3">Set your daily target income to track yearly performance and achieve your financial goals.</p>
